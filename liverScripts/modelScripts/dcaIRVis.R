...
reperfusionNoDCA <- feather::read_feather("../results/resultsReperfusionPool12.feather")

par(mfrow = c(1, 1))
plot(reperfusionDCA$t, reperfusionDCA$NADH_x/(0.824e-3*0.5), cex = 0.1, col = "red",
     ylim = c(0, 1), ylab = "Redox State of NADH", xlab = "Time (s)")
lines(reperfusionDCA$t, reperfusionDCA$NADH_x/(0.824e-3*0.5), cex = 0.1, col = "red")
...
plot(shortreperfusionDCA$t, shortreperfusionDCA$NADH_x/(0.824e-3*0.5), cex = 0.1, col = "blue",
     ylim = c(0, 1), ylab = "Redox State of NADH", xlab = "Time (s)")
lines(shortreperfusionDCA$t, shortreperfusionDCA$NADH_x/(0.824e-3*0.5), cex = 0.1, col = "blue")
lines(shortreperfusionNoDCA$t, shortreperfusionNoDCA$NADH_x/(0.824e-3*0.5), col = "red")
