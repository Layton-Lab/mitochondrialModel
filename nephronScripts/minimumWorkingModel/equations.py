...
def conservationEqs(x, J_AtC, ExpType = 1, StateType = 1,
    ...
    """The equation first computes the fluxes, and then
    calculates the differential equations based on the fluxes returned.
    conservationEqs assumes constant ATP consumption.  tubule argument
    allows you to decide between the proximal tubule (PT) and the
