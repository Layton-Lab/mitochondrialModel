...
def main(): ## Runs differential equation for time span and outputs results to
    ...
    for i in range(19):
        ...
        if i == 18:
            ...
            pW = 10.0
        glyc = 0.0
        #glyc = 1.83e-5 ## Default is to comment this out
        ...
        results = pd.DataFrame(results,
                            columns = ["t", "H_x", "dPsi", "ATP_x", "ADP_x",
                                      ...
                                      "PCr_c", "AMP_c"])
        results.to_csv("../results/resultsMPmTAL"+str(i)+".csv")
        feather.write_dataframe(results, "../results/resultsMPmTAL"+str(i)+"Fe.feather")
