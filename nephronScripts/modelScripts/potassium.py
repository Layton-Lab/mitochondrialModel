...
def f(t, y, i = 10): ## Differential equations, with optional arguments specified
    print(t)
    if t > 30:
...
def main(): ## Runs differential equation for time span and outputs results to
    ...
    for j in range(10):
        ...
        feather.write_dataframe(results, "../results/resultsNigericin"+str(j+1)+".feather")
        print(results)
